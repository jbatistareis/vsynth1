...
public class KeyboardInputProcessor implements InputProcessor {
    ...
    public KeyboardInputProcessor(KeyboardPanel keyboardPanel) {
    ...
    void shiftOctaveLeft() {
        ...
        keyboardPanel.shiftOctaveLeft(octaveIndex + 2);
    }
    ...
    void shiftOctaveRight() {
        ...
        keyboardPanel.shiftOctaveRight(octaveIndex + 2);
    }

    void pressKey(int index) {
        keyboardPanel.pressKey(index + keyIndexOffset);
    }

    void releaseKey(int index) {
        keyboardPanel.releaseKey(index + keyIndexOffset);
    }
